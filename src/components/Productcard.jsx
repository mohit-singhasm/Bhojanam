...
const Productcard = ({ img, name, price, addToCart }) => {
    return (
        <div className='border border-gray-200 hover:border-gray-300 hover:scale-105 transition-transform rounded-lg relative'>
            ...
            <div className='space-y-2 p-4 relative'>
                ...
                <div className='absolute -top-2 right-2 bg-accent text-white text-[28px] w-[50px] h-[50px] rounded-full grid place-items-center cursor-pointer' onClick={() => addToCart(img, name, price)} >
                    <AiOutlineShopping />
                </div>
            </div>
        </div>
