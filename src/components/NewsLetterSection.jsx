            ...
            <div className="container py-8 flex flex-col md:flex-row justify-between items-center gap-4 text-white">
                <div className="flex flex-shrink-0 items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="">...and receive $20 coupon for first shopping</p>
                    </div>
                </div>
                <div className="w-full max-w-[500px] relative">
                    <input className="py-4 px-6 w-full rounded-full" type="text" placeholder="Your Email address...." />

                    <button className="bg-accentDark absolute bottom-[50%] right-2 translate-y-[50%] py-2 px-4 rounded-full hover:bg-accent" >Subscribe!</button>
                </div>
            </div>
        </div>
    )
